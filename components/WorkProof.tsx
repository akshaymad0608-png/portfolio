...
const WorkProof: React.FC = () => {
  ...
  return (
    <section className="py-20 md:py-24 relative bg-background border-t border-border overflow-hidden">
      
      <div className="container mx-auto px-6 relative z-10">
        <div className="flex justify-center md:justify-end mb-8 max-w-6xl mx-auto">
            <span className="text-slate-400 font-mono text-xs flex items-center gap-2 border border-border px-4 py-2 rounded-full glass-card tracking-widest uppercase"><Clock size={14}/> Operational Metrics</span>
        </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-10 md:gap-16 relative z-10">
              {stats.map((stat, index) => {
                ...
                return (
                  ...
                  >
                    <div className={`p-4 rounded-2xl bg-white/5 border border-border mb-6 group-hover:scale-110 transition-transform duration-300 ${stat.color}`}>
