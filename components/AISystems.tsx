    ...
    <section id="systems" className="py-20 md:py-32 bg-[#050A15] relative border-t border-white/5 scroll-mt-20">
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        >
          ...
          <h2 className="text-3xl md:text-5xl font-black text-white mb-6">AI Systems I Can <span className="text-transparent bg-clip-text bg-gradient-to-r from-electric to-neonLime">Build</span></h2>
