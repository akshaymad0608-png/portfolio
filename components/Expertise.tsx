    ...
    <section id="expertise" className="py-16 md:py-32 relative bg-midnight scroll-mt-32">
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        >
          ...
          <h2 className="text-3xl sm:text-5xl md:text-7xl font-bold text-white mb-6">Technological <span className="text-transparent bg-clip-text bg-gradient-to-r from-electric to-neonLime">Arsenal</span></h2>
        </motion.div>
            ...
            return (
              ...
              >
                ...
                <div className="mb-8 relative">
                  ...
                  <div className="absolute top-0 right-0 font-mono text-white/10 text-6xl font-bold select-none pointer-events-none">
                    0{index + 1}
                  </div>
                </div>

                <h3 className="text-2xl font-bold text-white mb-4 tracking-tight group-hover:text-electric transition-colors">{skill.name}</h3>
                ...
                {skill.demoLink && (
                  <a 
                    ...
                    className="mt-auto w-full py-4 flex items-center justify-center gap-3 rounded-2xl bg-white/5 border border-white/10 text-white font-bold text-sm uppercase tracking-widest hover:bg-electric hover:text-midnight hover:border-electric transition-all duration-500 group-hover:shadow-[0_0_30px_rgba(0,240,255,0.25)]"
                  >
