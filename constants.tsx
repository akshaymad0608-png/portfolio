...
export const INTERNAL_BUILDS: InternalBuild[] = [
  {
    ...
    diagram: { src: "/diagrams/shots/ai-news.png", caption: "The n8n canvas for the news collector — the workflow in this stack that runs live" },
  },
  {
    id: 2,
    title: "Sweet Crumbs",
  ...
  },
  {
    ...
    diagram: { src: "/diagrams/shots/jewellery-bi.png", caption: "The n8n canvas for the master orchestrator; the other twelve run as sub-workflows" },
  },
  {
    id: 5,
    ...
    diagram: { src: "/diagrams/shots/job-engine.png", caption: "The n8n canvas, from the five job feeds to the sent application" },
  },
  {
    id: 6,
    ...
    diagram: { src: "/diagrams/shots/lead-engine.png", caption: "The n8n canvas, from unread mail to the answered enquiry" },
  },
];
